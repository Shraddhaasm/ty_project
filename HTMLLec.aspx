<%@ Page Title="" Language="C#" MasterPageFile="~/ContentStu.Master" AutoEventWireup="true" CodeBehind="HTMLLec.aspx.cs" Inherits="Eduspire3.HTMLLec" %>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-12 login-sec">
                                    <div class="card-body p-md-3 text-black">
                                        <h2 style="margin-top: -56px;" class="text-center">HTML Lectures</h2>
