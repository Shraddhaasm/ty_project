<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassForStu.aspx.cs" Inherits="Eduspire3.ForgotPassForStu" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 login-sec">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RequiredFieldValidator ID="rfvEmailID" class="error" runat="server" ControlToValidate="txtEmailID" ErrorMessage="Please enter your 'E-mail ID'." ForeColor="Red" SetFocusOnError="True" ValidationGroup="Login" style="height: 19px"></asp:RequiredFieldValidator>
                        ...
                        <div class="d-flex justify-content-end pt-3" id="div_VerifyOtp" runat="server">
                         ...
                         <div class="copy-text" style="margin-left: 40px">
                            ...
                            <a href="VerifyStudent.aspx">Student Registration</a>
                           <%-- <br />
