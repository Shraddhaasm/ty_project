<%@ Page Title="" Language="C#" MasterPageFile="~/ContentStu.Master" AutoEventWireup="true" CodeBehind="ExamDetailsStu.aspx.cs" Inherits="Eduspire3.ExamDetailsStu" %>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-12 login-sec">
                                    <div class="card-body p-md-3 text-black">
                                        <h2 style="margin-top: -56px;" class="text-center">Exam Details</h2>
...
<ItemStyle Width="15%"></ItemStyle>
                                                    ...
                                                    <asp:TemplateField HeaderText="Test valid till Date" ItemStyle-Width="15%">
                                                        <ItemTemplate>
...
<ItemStyle Width="15%"></ItemStyle>
                                                    ...
                                                    <asp:TemplateField HeaderText="Number of Attempts" ItemStyle-Width="15%">
                                                        <ItemTemplate>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="modal-title">
                           Exam Duration: <lable> Hours : Minutes <lable id="Duration">
                        </h6>
                         <h6 class="modal-title">
                           Course Name: <lable id="Course"></lable>
                        </h6>
                         <h6 class="modal-title">
                           Passing Percentage: <lable id="PassingPercentage"></lable>%
                        </h6> <h6 class="modal-title">
                           Total Questions:  <lable id="TotalQuesstion"></lable>
                        </h6>
                        <h6 class="modal-title">
                           Marks for each correct Answer: <lable id="Marksforeach"></lable> 
                        </h6>
                         <h6 class="modal-title">
                         Total Marks: 100
                        </h6>
                        ...
                        <ul>
                            ...
                            <li><h4 style="color:forestgreen"> BEST OF LUCK FROM EDUSPIRE !!!</h4></li>
                        </ul>
                    </div>
