<%@ Page Title="" Language="C#" MasterPageFile="~/ContentTut.Master" AutoEventWireup="true" CodeBehind="DetailsTutor.aspx.cs" Inherits="Eduspire3.DetailsTutor" %>
    ...
    <form id="form2" runat="server">
        ...
        <h5 class="text-left color"> First Name: </h5>  
           ...
           <h5 class="text-left color">   Email Address: </h5> 
            ...
            <asp:Label ID="lblDate" class="col-4"  Font-Size="Large" runat="server"></asp:Label>
            <br />
             </div> 
         </div>
        </div>
